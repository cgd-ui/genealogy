<template>
  <AuthIndex>
    <template #form>
      <form
        class="column is-6-tablet is-7-desktop is-7-widescreen is-7-fullhd is-gapless is-flex ai--c"
      ...
      >
        <div class="auth-form is-gapless">
          <div>
            ...
            <div>
              <p
                class="is-size-6 has-text-dark has-text-centered has-text-weight-regular"
              >
...
export default {
  ...
  computed: {
    ...
    config() {
      return this._isWebview ? { headers: { isWebview: true } } : {};
    },
  },
  methods: {
    validate() {
